...
class WindowKeyController:
    """
    Attaches a key listener to a top-level Gtk.Window using the CAPTURE phase.
    """
    ...
    def _install(self):
        ...
        logger.info(f"Attached key controller for keyval {self.target_keyval} to Nautilus window.")
